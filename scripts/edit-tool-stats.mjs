...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".tsar/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".tsar/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.tsar/agent/sessions)
