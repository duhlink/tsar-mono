...
import type { AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel } from "@tsar/agent-core";
import type {
	Api,
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@tsar/coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@tsar/coding-agent";
	 *
