 ...
 * Encodes cwd into a safe directory name under ~/.tsar/agent/sessions/.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.tsar/agent/sessions/<encoded-cwd>/).
	 */
