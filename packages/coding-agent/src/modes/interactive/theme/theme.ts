...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@tsar/tui";
...
const THEME_KEY = Symbol.for("@tsar/coding-agent:theme");
...
export function getSettingsListTheme(): import("@tsar/tui").SettingsListTheme {
	return {
