...
/**
 * Migrate sessions from ~/.tsar/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.tsar/agent/ instead of
 * ~/.tsar/agent/sessions/<encoded-cwd>/. This migration moves them
