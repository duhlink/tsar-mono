...
import type { BashToolDetails, EditToolDetails, ExtensionAPI, ReadToolDetails } from "@tsar/coding-agent";
import { createBashTool, createEditTool, createReadTool, createWriteTool } from "@tsar/coding-agent";
