 ...
 * Delegates to tsar-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   tsar -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
