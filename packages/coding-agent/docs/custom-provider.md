...
models: [{
  ...
  compat: {
    ...
    reasoningEffortMap: {              // map tsar-ai levels to provider values
      minimal: "default",
      low: "default",
      medium: "default",
      high: "default",
...
```typescript
import type { OAuthCredentials, OAuthLoginCallbacks } from "@tsar/ai";
...
Credentials are persisted in `~/.tsar/agent/auth.json`:
