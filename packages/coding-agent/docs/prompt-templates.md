> tsar can create prompt templates. Ask it to build one for your workflow.
...
Tsar loads prompt templates from:

- Global: `~/.tsar/agent/prompts/*.md`
- Project: `.tsar/prompts/*.md`
