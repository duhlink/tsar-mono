...
Reusable web UI components for building AI chat interfaces powered by [@tsar/ai](../ai) and [@tsar/agent-core](../agent).
...
```bash
npm install @tsar/web-ui @tsar/agent-core @tsar/ai
```
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@tsar/web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@tsar/web-ui';
...
```typescript
import { createExtractDocumentTool } from '@tsar/web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@tsar/web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@tsar/web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@tsar/web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@tsar/web-ui';
...
```typescript
import { SessionListDialog } from '@tsar/web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@tsar/web-ui';
...
```typescript
import { ModelSelector } from '@tsar/web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@tsar/web-ui';
...
- [sitegeist](https://sitegeist.ai) - Browser extension using tsar-web-ui
